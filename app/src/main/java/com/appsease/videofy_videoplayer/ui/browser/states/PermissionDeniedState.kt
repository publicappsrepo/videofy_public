...
package com.appsease.videofy_videoplayer.ui.browser.states
...
fun PermissionDeniedState(
      ...
      Column(
        ...
        Card(
          ...
          Column(
            ...
            Text(
              text = "videofy requires \"All file access\" permission to discover media and subtitles on your device due to a change in security policy in Android 11 and later versions.",
  ...
  if (showExplanationDialog) {
    ...
    val githubUrl = "https://github.com/marlboro-advance/videofy"
    ...
    AlertDialog(
      ...
      text = {
        Column(
          ...
          Text(
            text = "videofy has always required storage access permission as it's essential for the app to find all media and subtitle files on your device, including the ones that are not supported by the system.",
            style = MaterialTheme.typography.bodyMedium,
          ...
          Text(
            text = "videofy is an open source project. You can review the source code and verify how permissions are used by visiting our GitHub repository at:",
            style = MaterialTheme.typography.bodyMedium,
            color = MaterialTheme.colorScheme.onSurfaceVariant,
          )
