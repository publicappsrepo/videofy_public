package com.appsease.videofy_videoplayer.ui.browser.filesystem
...
import com.appsease.videofy_videoplayer.ui.browser.components.BrowserBottomBar
import com.appsease.videofy_videoplayer.ui.browser.components.BrowserTopBar
import com.appsease.videofy_videoplayer.ui.browser.dialogs.AddToPlaylistDialog
import com.appsease.videofy_videoplayer.ui.browser.dialogs.DeleteConfirmationDialog
import com.appsease.videofy_videoplayer.ui.browser.dialogs.FileOperationProgressDialog
import com.appsease.videofy_videoplayer.ui.browser.dialogs.FolderPickerDialog
import com.appsease.videofy_videoplayer.ui.browser.dialogs.GridColumnSelector
import com.appsease.videofy_videoplayer.ui.browser.dialogs.RenameDialog
...
import com.appsease.videofy_videoplayer.utils.media.CopyPasteOps
 ...
 */
@Serializable
object FileSystemBrowserRootScreen : com.appsease.videofy_videoplayer.presentation.Screen {
...
data class FileSystemDirectoryScreen(
  val path: String,
) : com.appsease.videofy_videoplayer.presentation.Screen {
  @OptIn(ExperimentalPermissionsApi::class)
  @Composable
  override fun Content() {
...
fun FileSystemBrowserScreen(path: String? = null) {
  ...
  val navigationBarHeight = com.appsease.videofy_videoplayer.ui.browser.LocalNavigationBarHeight.current
  ...
  LaunchedEffect(
    ...
    if (isAtRoot) {
      try {
        val mainScreenObj = com.appsease.videofy_videoplayer.ui.browser.MainScreen
          ...
          val results = if (isAtRoot) {
            ...
            parentDirectories.forEach { parentPath ->
              try {
                ...
                val parentResults = com.appsease.videofy_videoplayer.ui.browser.filesystem.searchRecursively(context, parentPath, searchQuery)
            ...
            items.filterIsInstance<FileSystemItem.Folder>().forEach { storageVolume ->
              try {
                ...
                val rootResults = com.appsease.videofy_videoplayer.ui.browser.filesystem.searchRecursively(context, storageVolume.path, searchQuery)
            ...
            val results = com.appsease.videofy_videoplayer.ui.browser.filesystem.searchRecursively(context, currentPath, searchQuery)
    ...
    Scaffold(
      topBar = {
        if (isSearching) {
          ...
          BrowserTopBar(
            title = if (isAtRoot) {
              stringResource(com.appsease.videofy_videoplayer.R.string.app_name)
            } else {
            ...
            onInfoClick = if (videoSelectionManager.isInSelectionMode && !folderSelectionManager.isInSelectionMode) {
              {
                ...
                if (video != null) {
                  val intent = Intent(context, com.appsease.videofy_videoplayer.ui.mediainfo.MediaInfoActivity::class.java)
          ...
          FloatingActionButtonMenu(
                ...
                ToggleFloatingActionButton(
                  modifier = Modifier
                    .animateFloatingActionButton(
                      visible = !isInSelectionMode && isFabVisible.value && !com.appsease.videofy_videoplayer.ui.browser.MainScreen.getPermissionDeniedState(),
            ...
            FloatingActionButtonMenuItem(
              onClick = {
                isFabExpanded.value = false
                coroutineScope.launch {
                  val recentlyPlayedVideos = com.appsease.videofy_videoplayer.utils.history.RecentlyPlayedOps.getRecentlyPlayed(limit = 1)
...
suspend fun searchRecursively(
  ...
  try {
    ...
    val items = com.appsease.videofy_videoplayer.repository.MediaFileRepository
...
private suspend fun collectVideosRecursively(
  context: Context,
  folderPath: String,
): List<com.appsease.videofy_videoplayer.domain.media.model.Video> {
  val videos = mutableListOf<com.appsease.videofy_videoplayer.domain.media.model.Video>()
...
private fun playVideosAsPlaylist(
  context: Context,
  videos: List<com.appsease.videofy_videoplayer.domain.media.model.Video>,
) {
...
private fun FileSystemBrowserContent(
  ...
  error: String?,
  isAtRoot: Boolean,
  breadcrumbs: List<com.appsease.videofy_videoplayer.domain.browser.PathComponent>,
  ...
  onVideoLongClick: (com.appsease.videofy_videoplayer.domain.media.model.Video) -> Unit,
  onBreadcrumbClick: (com.appsease.videofy_videoplayer.domain.browser.PathComponent) -> Unit,
  folderSelectionManager: com.appsease.videofy_videoplayer.ui.browser.selection.SelectionManager<FileSystemItem.Folder, String>,
  videoSelectionManager: com.appsease.videofy_videoplayer.ui.browser.selection.SelectionManager<com.appsease.videofy_videoplayer.domain.media.model.Video, Long>,
  modifier: Modifier = Modifier,
  isInSelectionMode: Boolean = false,
) {
  val gesturePreferences = koinInject<GesturePreferences>()
  val browserPreferences = koinInject<BrowserPreferences>()
  val thumbnailRepository = koinInject<com.appsease.videofy_videoplayer.domain.thumbnail.ThumbnailRepository>()
            ...
            LazyVerticalGrid(
              ...
              if (!isAtRoot && breadcrumbs.isNotEmpty()) {
                item(span = { GridItemSpan(maxLineSpan) }) {
                  com.appsease.videofy_videoplayer.ui.browser.filesystem.BreadcrumbNavigation(
                    breadcrumbs = breadcrumbs,
              ...
              items(
                ...
                val folderModel = com.appsease.videofy_videoplayer.domain.media.model.VideoFolder(
...
fun FileSystemSortDialog(
  ...
  val browserPreferences = koinInject<BrowserPreferences>()
  val appearancePreferences = koinInject<com.appsease.videofy_videoplayer.preferences.AppearancePreferences>()
  ...
  SortDialog(
    ...
    onSortTypeChange = { typeName ->
      com.appsease.videofy_videoplayer.preferences.FolderSortType.entries.find { it.displayName == typeName }?.let {
    ...
    onSortOrderChange = { isAsc ->
      browserPreferences.folderSortOrder.set(
        if (isAsc) com.appsease.videofy_videoplayer.preferences.SortOrder.Ascending
        else com.appsease.videofy_videoplayer.preferences.SortOrder.Descending,
      )
    },
    types = listOf(
      com.appsease.videofy_videoplayer.preferences.FolderSortType.Title.displayName,
      com.appsease.videofy_videoplayer.preferences.FolderSortType.Date.displayName,
      com.appsease.videofy_videoplayer.preferences.FolderSortType.Size.displayName,
    ),
    icons = listOf(
      Icons.Filled.Title,
    ...
    getLabelForType = { type, _ ->
      when (type) {
        com.appsease.videofy_videoplayer.preferences.FolderSortType.Title.displayName -> Pair("A-Z", "Z-A")
        com.appsease.videofy_videoplayer.preferences.FolderSortType.Date.displayName -> Pair("Oldest", "Newest")
        com.appsease.videofy_videoplayer.preferences.FolderSortType.Size.displayName -> Pair("Smallest", "Largest")
        else -> Pair("Asc", "Desc")
      }
    },
    ...
    viewModeSelector = ViewModeSelector(
      ...
      isFirstOptionSelected = folderViewMode == com.appsease.videofy_videoplayer.preferences.FolderViewMode.AlbumView,
      onViewModeChange = { isFirstOption ->
        browserPreferences.folderViewMode.set(
          if (isFirstOption) {
            com.appsease.videofy_videoplayer.preferences.FolderViewMode.AlbumView
          } else {
            com.appsease.videofy_videoplayer.preferences.FolderViewMode.FileManager
          },
        )
      },
    ),
