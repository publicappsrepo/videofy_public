package com.appsease.videofy_videoplayer.ui.browser.playlist
...
import com.appsease.videofy_videoplayer.ui.browser.cards.M3UVideoCard
            ...
            FloatingActionButton(
              ...
              onClick = {
                coroutineScope.launch {
                  ...
                  val recentlyPlayedVideos = com.appsease.videofy_videoplayer.utils.history.RecentlyPlayedOps.getRecentlyPlayed(limit = 100)
...
private fun PlaylistVideoListContent(
  ...
  isLoading: Boolean,
  selectionManager: com.appsease.videofy_videoplayer.ui.browser.selection.SelectionManager<PlaylistVideoItem, Int>,
  ...
  val browserPreferences = koinInject<com.appsease.videofy_videoplayer.preferences.BrowserPreferences>()
