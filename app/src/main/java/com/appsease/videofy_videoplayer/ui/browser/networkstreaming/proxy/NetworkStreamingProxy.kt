package com.appsease.videofy_videoplayer.ui.browser.networkstreaming.proxy

import android.util.Log
import com.appsease.videofy_videoplayer.domain.network.NetworkConnection
import com.appsease.videofy_videoplayer.ui.browser.networkstreaming.clients.NetworkClient
import com.appsease.videofy_videoplayer.ui.browser.networkstreaming.clients.NetworkClientFactory
    ...
    return runBlocking {
      try {
        when (streamInfo.client) {
          is com.appsease.videofy_videoplayer.ui.browser.networkstreaming.clients.SmbClient -> {
            getFileSizeSMB(streamInfo)
          }

          is com.appsease.videofy_videoplayer.ui.browser.networkstreaming.clients.FtpClient -> {
            getFileSizeFTP(streamInfo)
          }

          is com.appsease.videofy_videoplayer.ui.browser.networkstreaming.clients.WebDavClient -> {
            val webDavClient =
              streamInfo.client as com.appsease.videofy_videoplayer.ui.browser.networkstreaming.clients.WebDavClient
            ...
            val ftpClient =
              streamInfo.client as? com.appsease.videofy_videoplayer.ui.browser.networkstreaming.clients.FtpClient
