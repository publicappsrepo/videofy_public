      ...
      ProvidePreferenceLocals {
        val locationPicker =
          rememberLauncherForActivityResult(
            ...
            preferences.videofyConfStorageUri.set(uri.toString())
          }
        ...
        LazyColumn(
          ...
          item {
            PreferenceSectionHeader(title = "Videofy Configuration")
          }
          
          item {
            PreferenceCard {
              var mpvConf by remember { mutableStateOf(preferences.videofyConf.get()) }
              ...
              LaunchedEffect(mpvConfStorageLocation) {
                ...
                withContext(Dispatchers.IO) {
                  ...
                  runCatching {
                    ...
                    val mpvConfFile = tree?.findFile("videofy.conf")
                    if (mpvConfFile != null && mpvConfFile.exists()) {
                      ...
                      preferences.videofyConf.set(content)
                      File(context.filesDir, "videofy.conf").writeText(content)
              ...
              TwoTargetIconButtonPreference(
                title = { Text(stringResource(R.string.pref_advanced_conf_storage_location)) },
                summary = {
                ...
                onIconButtonClick = { preferences.videofyConfStorageUri.delete() },
          ...
          item {
            PreferenceCard {
              ...
              val videofyDatabase = koinInject<VideofyExDatabase>()
                ...
                ConfirmDialog(
                  ...
                  onConfirm = {
                    scope.launch(Dispatchers.IO) {
                      runCatching {
                        videofyDatabase.videoDataDao().clearAllPlaybackStates()
          ...
          item {
            PreferenceCard {
              ...
              Preference(
                ...
                summary = { 
                  Text(
                    text = "Clear the cached videofy.conf settings",
                    color = MaterialTheme.colorScheme.outline,
                  ) 
                },
                onClick = {
                  scope.launch(Dispatchers.IO) {
                    ...
                    preferences.videofyConf.delete()
                    withContext(Dispatchers.Main) {
                      mpvConf = ""
                      Toast
                        .makeText(
