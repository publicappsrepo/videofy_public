...
import com.appsease.videofy_videoplayer.ui.player.controls.components.panels.toColorHexString
...
class VideofyView(
  ...
  private val observedProps =
    mapOf(
      ...
      "user-data/videofy/show_text" to MPVLib.MpvFormat.MPV_FORMAT_STRING,
      "user-data/videofy/toggle_ui" to MPVLib.MpvFormat.MPV_FORMAT_STRING,
      "user-data/videofy/show_panel" to MPVLib.MpvFormat.MPV_FORMAT_STRING,
      "user-data/videofy/set_button_title" to MPVLib.MpvFormat.MPV_FORMAT_STRING,
      "user-data/videofy/reset_button_title" to MPVLib.MpvFormat.MPV_FORMAT_STRING,
      "user-data/videofy/toggle_button" to MPVLib.MpvFormat.MPV_FORMAT_STRING,
      "user-data/videofy/seek_by" to MPVLib.MpvFormat.MPV_FORMAT_STRING,
      "user-data/videofy/seek_to" to MPVLib.MpvFormat.MPV_FORMAT_STRING,
      "user-data/videofy/seek_by_with_text" to MPVLib.MpvFormat.MPV_FORMAT_STRING,
      "user-data/videofy/seek_to_with_text" to MPVLib.MpvFormat.MPV_FORMAT_STRING,
      "user-data/videofy/software_keyboard" to MPVLib.MpvFormat.MPV_FORMAT_STRING,
    )
