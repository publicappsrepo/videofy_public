package com.appsease.videofy_videoplayer.domain.anime4k
...
class Anime4KManager(private val context: Context) {
  ...
  enum class Quality(val suffix: String, val titleRes: Int) {
    FAST("S", com.appsease.videofy_videoplayer.R.string.anime4k_quality_fast),
    BALANCED("M", com.appsease.videofy_videoplayer.R.string.anime4k_quality_balanced),
    HIGH("L", com.appsease.videofy_videoplayer.R.string.anime4k_quality_high)
  }

  // Anime4K modes
  enum class Mode(val titleRes: Int) {
    OFF(com.appsease.videofy_videoplayer.R.string.anime4k_mode_off),
    A(com.appsease.videofy_videoplayer.R.string.anime4k_mode_a),
    B(com.appsease.videofy_videoplayer.R.string.anime4k_mode_b),
    C(com.appsease.videofy_videoplayer.R.string.anime4k_mode_c),
    A_PLUS(com.appsease.videofy_videoplayer.R.string.anime4k_mode_a_plus),
    B_PLUS(com.appsease.videofy_videoplayer.R.string.anime4k_mode_b_plus),
    C_PLUS(com.appsease.videofy_videoplayer.R.string.anime4k_mode_c_plus)
  }
