...
import com.appsease.videofy_videoplayer.utils.storage.FolderScanUtils
import com.appsease.videofy_videoplayer.utils.storage.StorageScanUtils
...
object MediaFileRepository : KoinComponent {
  ...
  private fun createVideoFromFileWithMetadata(
    ...
    bucketId: String,
    bucketDisplayName: String,
    metadata: com.appsease.videofy_videoplayer.utils.media.MediaInfoOps.VideoMetadata?,
  ): Video {
    val path = file.absolutePath
    val displayName = file.name
    val title = file.nameWithoutExtension
